...
export function OrderTableFilters() {
    ...
    return (
        <form className="flex items-center gap-2" onSubmit={handleSubmit(handleFilter)}>
            ...
            <Input type="text" placeholder="Id do Pedido" className="h-8 w-auto" {...register("orderId")} />
            <Input type="text" placeholder="Nome do Cliente" className="h-8 w-[320px]" {...register("customerName")} />
